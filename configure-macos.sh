...
sudo scutil --set ComputerName "Altair"
sudo scutil --set HostName "Altair"
sudo scutil --set LocalHostName "Altair"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Altair"
